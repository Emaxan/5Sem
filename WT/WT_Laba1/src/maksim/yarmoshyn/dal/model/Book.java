...
/**
 * Book class. Contain data about book in database.
 */
public class Book
        extends BaseEntity
        implements Entity {
    ...
    public String toString() {
        return translateSpecialSymbols(String.valueOf(this.getId()))
                + getSpecialSymbol() + translateSpecialSymbols(this.getAuthor())
    ...
    /**
     * Initialize book from string representation.
     *
    ...
    public void fromString(final String record) {
        ...
        this.setAuthor(translateSpecialSymbols(fields[1]));
        this.setName(translateSpecialSymbols(fields[2]));
        this.setYear(Integer.parseInt(translateSpecialSymbols(fields[3])));
    }
